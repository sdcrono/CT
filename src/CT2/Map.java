...
//				score_sv[n] = Integer.parseInt(in.next());
				...
				textScore = String.valueOf(i) + ". " + String.valueOf(Score.score_sv[i]);
			...
			textScore = "Your score : " + String.valueOf(TanksPlayer.score);
			textLayoutScore = new TextLayout(textScore, font, g1.getFontRenderContext());
		...
		public void keyPressed(KeyEvent e) {
			...
			if(e.getKeyCode()== KeyEvent.VK_1 && ClashofTanks.Intro)
			{
				ClashofTanks.Co_Op = false;
				ClashofTanks.pause = false;
				ClashofTanks.Intro = false;
			}
			if(e.getKeyCode()== KeyEvent.VK_2 && ClashofTanks.Intro)
			{
