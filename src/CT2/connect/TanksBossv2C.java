...
public class TanksBossv2C extends TanksBotC{
	...
	public TanksBossv2C(int x, int y, int huong,int type, int size)
	{
	...
	*/
	...
	public boolean True_Move(int x, int y, int h)
	{
		...
		if(h == 0 || h == 2)
			if(MapC.map[x][y].Get() != 0 || MapC.map[x+24][y].Get() != 0 ||MapC.map[x+49][y].Get() != 0)
				return false;
		
		if(h == 1 || h == 3)
			if(MapC.map[x][y].Get() != 0 || MapC.map[x][y+24].Get() != 0 || MapC.map[x][y+49].Get() != 0)
				return false;
		...
		while(!(A[0]==A[1]&&A[2]==A[3]))
		{
			...
			if(r == A[0])
			{
				...
				//	if((super.Y-10)>24 &&  Map.map[super.X][super.Y-10].Get()==0 && Map.map[super.X+14][super.Y-10].Get()==0 && Map.map[super.X+29][super.Y-10].Get()==0)
					if((super.Y-10)>24 &&  MapC.map[super.X][super.Y-10].Get()==0 && MapC.map[super.X+24][super.Y-10].Get()==0 && MapC.map[super.X+49][super.Y-10].Get()==0)
					{
						if(r == this.huong)
							return 0;	
					}
			...
			if(r == A[1])
			{
				...
				//	if((super.X+40)<875 && Map.map[super.X+40][super.Y].Get()==0 && Map.map[super.X+40][super.Y+14].Get()==0 && Map.map[super.X+40][super.Y+29].Get()==0) //Sua lai chieu ngang.
					if((super.X+60)<875 && MapC.map[super.X+60][super.Y].Get()==0 && MapC.map[super.X+60][super.Y+24].Get()==0 && MapC.map[super.X+60][super.Y+49].Get()==0) //Sua lai chieu ngang.
					{
						if(r == this.huong)
						return 1;
					}
			...
			if(r == A[2])
			{
				...
				//	if((super.Y+40)<725 && Map.map[super.X][super.Y+40].Get()==0 && Map.map[super.X+14][super.Y+40].Get()==0 && Map.map[super.X+29][super.Y+40].Get()==0)
					if((super.Y+60)<725 && MapC.map[super.X][super.Y+60].Get()==0 && MapC.map[super.X+24][super.Y+60].Get()==0 && MapC.map[super.X+49][super.Y+60].Get()==0) 
					{
						if(r == this.huong)
							return 2;
					}
			...
			if(r == A[3])
			{
				...
				//	if((super.X-10)>24 && Map.map[super.X-10][super.Y].Get()==0 && Map.map[super.X-10][super.Y+14].Get()==0 && Map.map[super.X-10][super.Y+29].Get()==0)
					if((super.X-10)>24 && MapC.map[super.X-10][super.Y].Get()==0 && MapC.map[super.X-10][super.Y+24].Get()==0 && MapC.map[super.X-10][super.Y+49].Get()==0)
					{
						if(r == this.huong)
							return 3;
					}
...
//			audio.Alarm_off();
	...
	public void Shoot()
	{
		if(this.t_delay_shoot == 0 && this.live )
		{
			...
			BulletC bullet1 = null ;
			BulletC bullet2 = null ;
			if(this.huong == 0)
			{
				bullet1 = new BulletC(this.X+20, this.Y-1, this.huong, 5, 4, 15, this.type);
				bullet2 = new BulletC(this.X+26, this.Y-1, this.huong, 5, 4, 15, this.type);
			}
			else
			if(this.huong == 1)
			{
				bullet1 = new BulletC(this.X+50, this.Y+20, this.huong, 5, 15, 4, this.type);
				bullet2 = new BulletC(this.X+50, this.Y+26, this.huong, 5, 15, 4, this.type);
			}
			else
			if(this.huong == 2)
			{
				bullet1 = new BulletC(this.X+20, this.Y+50, this.huong, 5, 4, 15, this.type);
				bullet2 = new BulletC(this.X+26, this.Y+50, this.huong, 5, 4, 15, this.type);
			}
			else
			if(this.huong == 3)
			{
				bullet1 = new BulletC(this.X-1, this.Y+20, this.huong, 5, 15, 4, this.type);
				bullet2 = new BulletC(this.X-1, this.Y+26, this.huong, 5, 15, 4, this.type);
			}
