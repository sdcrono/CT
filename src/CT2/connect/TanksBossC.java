...
public class TanksBossC extends TanksBotC{
	...
	public TanksBossC(int x, int y, int huong,int type, int size)
	{
...
//				return false;
	...
	*/
	...
	{
		int[] A= new int[20];// Do rong tam nhin cua xe tang la 10 don vi.
		boolean stop = false;
