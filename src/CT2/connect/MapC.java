...
import CT2.connect.ClashofTanksC ;
...
//	static Playout[][] map = new Playout[900][750];
	public static Playout[][] map = new Playout[900][750];
...
////				map[j][i].SetY(i);
////				if(!(i == 25 && j == 25))
////					System.out.println(i + " " + j + " " + map[j-1][i].x + " " + map[j-1][i].y + " " + map[j-1][i].type);
////				System.out.println(i + " " + j + " " + map[j][i].x + " " + map[j][i].y + " " + map[j][i].type);
////				map[j][i].SetObstacle(0);
//			}
//		
//		
//		//Khoi tao tuong bao ngoai.
...
//					{
//						map[i][j] = wall1;
////						map[i][j].SetObstacle(1);
//						map[i][j+725] = wall2;
////						map[i][j+725].SetObstacle(1);
//					}
//		}
//		
//		for(int n = 1; n<=30; n++)
...
//					{
//						map[j][i] = wall1;
////						map[j][i].SetObstacle(1);
//						map[j+875][i] = wall2;
////						map[j+875][i].SetObstacle(1);
//					}
//		}
//		//
//		
...
//				{
//					map[i.GetX()+u][i.GetY()+v] = i;
////					map[i.GetX()+u][i.GetY()+v].SetObstacle(1);
//				}
//			
//		}
//		
...
//	}
	...
	public static class Screen extends Frame implements KeyListener
	{
		...
		{
			String textVersion = "Prototype - Distrbu";
			...
			String textU = "^";
			String textLDR = "<  v  >";
			String textScore = "Score: "  +  String.valueOf(TanksPlayerC.score);
...
//				score_sv[n] = Integer.parseInt(in.next());
				...
				textScore = String.valueOf(i) + ". " + String.valueOf(ScoreC.score_sv[i]);
				textLayoutScore = new TextLayout(textScore, font, g1.getFontRenderContext());
				textLayoutScore.draw(g1, x + 75, y - 600 + i*50);
				
				g1.setPaint(new Color(150, 150, 150));
			}
			
			textScore = "Your score : " + String.valueOf(TanksPlayerC.score);
			textLayoutScore = new TextLayout(textScore, font, g1.getFontRenderContext());
			textLayoutScore.draw(g1, 300, 650);
		...
		public void keyPressed(KeyEvent e) {
			...
			if(e.getKeyCode()== KeyEvent.VK_1 && ClashofTanksC.Intro)
			{
				ClashofTanksC.Co_Op = false;
				ClashofTanksC.pause = false;
				ClashofTanksC.Intro = false;
			}
			if(e.getKeyCode()== KeyEvent.VK_2 && ClashofTanksC.Intro)
			{
				ClashofTanksC.Co_Op = true;
				ClashofTanksC.pause = false;
				ClashofTanksC.Intro = false;
			}

			if(e.getKeyCode()== KeyEvent.VK_ENTER && !ClashofTanksC.pause && !ClashofTanksC.Intro)
				ClashofTanksC.pause = true;
			else
				if(e.getKeyCode()== KeyEvent.VK_ENTER && !ClashofTanksC.Intro)
					ClashofTanksC.pause = false;
				
			for(TanksC o:TanksC.O_Tanks)
			{
				if(o.type==3 || o.type==2 || o.type==4)
				{
					if(o.N_player ==1)
					{
						if( e.getKeyCode()== KeyEvent.VK_UP || e.getKeyCode()== KeyEvent.VK_RIGHT || e.getKeyCode()==KeyEvent.VK_DOWN || e.getKeyCode()== KeyEvent.VK_LEFT || e.getKeyCode()==KeyEvent.VK_M || e.getKeyCode()==KeyEvent.VK_N || e.getKeyCode()==KeyEvent.VK_B || e.getKeyCode()==KeyEvent.VK_COMMA || e.getKeyCode()==KeyEvent.VK_G  || e.getKeyCode()==KeyEvent.VK_H || e.getKeyCode()==KeyEvent.VK_J || e.getKeyCode()==KeyEvent.VK_K) 
						{
							if(e.getKeyCode() == KeyEvent.VK_UP)
							{
								System.out.println("UP");
								try {
									ClashofTanksC .gui.writeUTF("UP");
							...
							if(e.getKeyCode() == KeyEvent.VK_DOWN)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("DOWN");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}								
							...
							if(e.getKeyCode() == KeyEvent.VK_LEFT)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("LEFT");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}
							...
							if(e.getKeyCode() == KeyEvent.VK_RIGHT)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("RIGHT");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}								
					...
					if( e.getKeyCode()== KeyEvent.VK_W || e.getKeyCode()== KeyEvent.VK_D || e.getKeyCode()==KeyEvent.VK_S || e.getKeyCode()== KeyEvent.VK_A || e.getKeyCode()==KeyEvent.VK_SPACE || e.getKeyCode()==KeyEvent.VK_Q || e.getKeyCode()==KeyEvent.VK_C) 
						o.Pressed(e);
					...
					if(o.N_player == 1)

						{
							if(e.getKeyCode() == KeyEvent.VK_UP)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("UPS");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}
							...
							if(e.getKeyCode() == KeyEvent.VK_DOWN)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("DOWNS");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}	
							...
							if(e.getKeyCode() == KeyEvent.VK_LEFT)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("LEFTS");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}
							...
							if(e.getKeyCode() == KeyEvent.VK_RIGHT)
							{
								...
								try {
									ClashofTanksC .gui.writeUTF("RIGHTS");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}	
							...
							if(e.getKeyCode() == KeyEvent.VK_COMMA){
								...
								try {
									ClashofTanksC .gui.writeUTF("COS");
								} catch (IOException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								}		
		...
		public static void audioLoop(String name) throws UnsupportedAudioFileException, LineUnavailableException
		{
		...
		public static void audioLoopStop(String name) throws UnsupportedAudioFileException, LineUnavailableException
		{
...
//				map[x+i][y+j] = wall;
//				if(ty==1)
//					map[x+i][y+j].SetObstacle(1);
//				if(ty==0)
//					map[x+i][y+j].SetObstacle(0);
//			}
//
//			
//		}
