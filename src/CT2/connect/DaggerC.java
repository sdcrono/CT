...
public class DaggerC extends BulletC{

	int host;//Dan tanks bot la 1, dan dong minh la 2.
	int lv=0;
	int maDan=0;
	public DaggerC(int x, int y, int huong, int type, int wi, int le, int host) {
	...
	public void CallBullets()
	{
		...
		if(lv >0)
		{
			...
			if(this.huong == 0) { this.Y -=5;}
			if(this.huong == 1) { this.X +=5;}
			if(this.huong == 2) { this.Y +=5;}
			if(this.huong == 3)	{ this.X -=5;}
	...
	public boolean Destroy_Tanks()
	{
		...
		if(this.huong == 0)
			for(TanksC o:TanksC.O_Tanks)
			{
				...
				if( ((this.X>=o.X && this.X<=(o.X+o.size -1)) || (this.X+this.width -1>=o.X && this.X+this.width -1<=(o.X+o.size -1))) && ( (o.Y +o.size -1 >= this.Y)  && o.Y <= this.Y))
				{
					if(o.armor>0)
						o.armor--;
					else
		...
		if(this.huong == 1)
			...
			{
				if(o.live ==true &&o.type == dich)
				if( ((this.Y>=o.Y && this.Y<=(o.Y+o.size -1)) || (this.Y+this.length-1>=o.Y && this.Y+this.length-1<=(o.Y+o.size -1))) && (o.X <= this.X && (o.X +o.size -1 >= this.X) ))
				{
					if(o.armor>0)
						o.armor--;
					else
		...
		if(this.huong == 2)
			...
			{
				if(o.live ==true &&o.type == dich)
				if( ((this.X>=o.X && this.X<=(o.X+o.size -1)) || (this.X+this.width-1>=o.X && this.X+this.width-1<=(o.X+o.size -1))) && (o.Y <= this.Y && (o.Y +o.size -1 >= this.Y) ))
				{
					if(o.armor>0)
						o.armor--;
					else
		...
		if(this.huong == 3)
			...
			{
				if(o.live ==true &&o.type == dich)
				if( ((this.Y>=o.Y && this.Y<=(o.Y+o.size -1)) || (this.Y+this.length-1>=o.Y && this.Y+this.length-1<=(o.Y+o.size -1))) && ( (o.X +o.size -1 >= this.X) && o.X <= this.X))
				{
					if(o.armor>0)
						o.armor--;
					else
...
//				if( ((this.X>=o.x && this.X<=(o.x+24)) || (this.X+this.width -1>=o.x && this.X+this.width -1<=(o.x+24))) && (o.y +24 >= this.Y && o.y <= this.Y))
//				{
//					o.Del_Wall();
//					t = true;
//				}
...
//			{
//				if(o.live ==true && o.type == 1)
//				if( ((this.Y>=o.y && this.Y<=(o.y+24)) || (this.Y+this.length-1>=o.y && this.Y+this.length-1<=(o.y+24))) && (o.x <= this.X && o.x +24 >= this.X) )
//				{
//					o.Del_Wall();
//					t = true;
//				}
...
//			{
//				if(o.live ==true && o.type == 1)
//				if( ((this.X>=o.x && this.X<=(o.x+24)) || (this.X+this.width-1>=o.x && this.X+this.width-1<=(o.x+24))) && (o.y <= this.Y && o.y +24 >= this.Y))
//				{
//					o.Del_Wall();
//					t = true;
//				}
...
//			{
//				if(o.live ==true && o.type == 1)
//				if( ((this.Y>=o.y && this.Y<=(o.y+24)) || (this.Y+this.length-1>=o.y && this.Y+this.length-1<=(o.y+24))) && (o.x +24 >= this.X && o.x <= this.X))
//				{
//					o.Del_Wall();
//					t = true;
//				}
	...
	public void Paint_Bullet(Graphics g)
	{
		...
		switch(this.huong)
		{
			case 0: case 2:
				...
				g.drawLine(this.X,this.Y,this.X,this.Y+this.width);
			
				g.setColor(this.color);
				for(int i=1;i<=(this.length-2);i++)
					g.drawLine(this.X+i,this.Y,this.X+i,this.Y+this.width);
				
				g.setColor(this.color.darker());
				g.drawLine(this.X+3,this.Y,this.X+3,this.Y+this.width);
				break;
