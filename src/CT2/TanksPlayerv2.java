...
public class TanksPlayerv2 extends Tanks  {
...
//	public static int delay_voice = 0;
	...
	public TanksPlayerv2(int x, int y, int huong, int type,  int size) {
		...
		if(type == 3 || type == 4)
			...
			Tanks.player_enemy ++;
		this.N_player = Tanks.player + Tanks.player_enemy; 
		O_Tanks.add(this);
...
//				this.color = Color.getHSBColor(0.01f, 1f, 0.75f);
		...
		if(TanksPlayerv2.streaktolive > 0)
			TanksPlayerv2.streaktolive--;
...
//				voice_long = true;
		...
		if(this.t_delay_flash == 0 && this.live)
		{
			...
			{
				if(this.Y-90 > 25)
					if(Map.map[this.X][this.Y-90].Get()==0 && Map.map[this.X+14][this.Y-90].Get()==0 && Map.map[this.X+29][this.Y-90].Get()==0
					&& Map.map[this.X][this.Y-75].Get()==0	&& Map.map[this.X+14][this.Y-75].Get()==0 && Map.map[this.X+29][this.Y-75].Get()==0
					&& Map.map[this.X][this.Y-60].Get()==0	&& Map.map[this.X+14][this.Y-60].Get()==0 && Map.map[this.X+29][this.Y-60].Get()==0)
					{
	//					this.flash_effect();
						super.DelRec();
			...
			{
				if(this.X+120 < 844)
					if(Map.map[this.X+120][this.Y].Get()==0 && Map.map[this.X+120][this.Y+14].Get()==0 && Map.map[this.X+120][this.Y+29].Get()==0
					&& Map.map[this.X+105][this.Y].Get()==0	&& Map.map[this.X+105][this.Y+14].Get()==0 && Map.map[this.X+105][this.Y+29].Get()==0
					&& Map.map[this.X+90][this.Y].Get()==0	&& Map.map[this.X+90][this.Y+14].Get()==0 && Map.map[this.X+90][this.Y+29].Get()==0)
					{
	//					this.flash_effect();
						super.DelRec();
			...
			{
				if(this.Y+120 < 694)
					if(Map.map[this.X][this.Y+120].Get()==0 && Map.map[this.X+14][this.Y+120].Get()==0 && Map.map[this.X+29][this.Y+120].Get()==0
					&& Map.map[this.X][this.Y+105].Get()==0	&& Map.map[this.X+14][this.Y+105].Get()==0 && Map.map[this.X+29][this.Y+105].Get()==0
					&& Map.map[this.X][this.Y+90].Get()==0	&& Map.map[this.X+14][this.Y+90].Get()==0 && Map.map[this.X+29][this.Y+90].Get()==0)
					{
	//					this.flash_effect();
						super.DelRec();
						super.Setlc(this.X, this.Y+90, this.huong);
			...
			{
				if(this.X-90 > 25)
					if(Map.map[this.X-90][this.Y].Get()==0 && Map.map[this.X-90][this.Y+14].Get()==0 && Map.map[this.X-90][this.Y+29].Get()==0
					&& Map.map[this.X-75][this.Y].Get()==0	&& Map.map[this.X-75][this.Y+14].Get()==0 && Map.map[this.X-75][this.Y+29].Get()==0
					&& Map.map[this.X-60][this.Y].Get()==0	&& Map.map[this.X-60][this.Y+14].Get()==0 && Map.map[this.X-60][this.Y+29].Get()==0)
					{
	//					this.flash_effect();
						super.DelRec();
						super.Setlc(this.X-90, this.Y, this.huong);
...
//			audio.Tank_flash_cd_unfinished_3();
		...
		if(this.t_delay_dagger == 0 && this.live)
		{
			...
			Dagger dagger = null ;
			if(this.huong == 0)
				dagger= new Dagger(this.X+13, this.Y-1, this.huong, 1, 10, 4, this.type);
			else
			if(this.huong == 1)
				dagger = new Dagger(this.X+30, this.Y+13, this.huong, 1, 10, 4, this.type);
			else
			if(this.huong == 2)
				dagger = new Dagger(this.X+13, this.Y+30, this.huong, 1, 10, 4, this.type);
			else
			if(this.huong == 3)
				dagger = new Dagger(this.X-1, this.Y+13, this.huong, 1, 10, 4, this.type);
		
			if (dagger != null)
			{
				audio.Tank_shoot();
				Tanks.O_Bullets.add(dagger);
			}				
...
//			audio.Tank_flash_cd_unfinished_3();
		...
		if(this.t_delay_shockwave == 0 && this.live)
		{
			...
			Shockwave shockwave1 = null ;
			Shockwave shockwave2 = null ;
			Shockwave shockwave3 = null ;
			if(this.huong == 0)
			{
				shockwave = new Shockwave(this.X-1, this.Y-1, this.huong, 999, 30, 50, this.type);
//				shockwave1 = new Shockwave(this.X+30, this.Y-1, 1, 999, 50, 30, this.type);
//				shockwave2 = new Shockwave(this.X-1, this.Y+30, 2, 999, 30, 50, this.type);
//				shockwave3 = new Shockwave(this.X-1, this.Y-1, 3, 999, 50, 30, this.type);
			}
			else
			if(this.huong == 1)
			...
			if (shockwave1 != null )
			{
				Tanks.O_Bullets.add(shockwave1);
			}				

			if (shockwave2 != null )
			{
				Tanks.O_Bullets.add(shockwave2);
			}				

			if (shockwave3 != null )
			{
				Tanks.O_Bullets.add(shockwave3);
			}				
	...
	public void Shoot_w2()
	{
		if(this.t_delay_shoot == 0 && this.live )
		{
			...
			if(this.huong == 0)
			{
				bullet1= new Bulletv2(this.X+13, this.Y-1, this.huong, 2, 4, 10, this.type, 1);
				bullet2= new Bulletv2(this.X+13, this.Y-1, this.huong, 2, 4, 10, this.type, 2);
			}
			else
			if(this.huong == 1)
			{
			...
			if(this.huong == 2)
			{
				bullet1 = new Bulletv2(this.X+13, this.Y+30, this.huong, 2, 4, 10, this.type,1);
				bullet2 = new Bulletv2(this.X+13, this.Y+30, this.huong, 2, 4, 10, this.type,2);
			}
			else
			if(this.huong == 3)
			{
	...
	public void Shoot_w3()
	{
		if(this.t_delay_shoot == 0 && this.live )
		{
			...
			Bulletv3 bullet4 = null ;
			Bulletv3 bullet5 = null ;
			if(this.huong == 0)
			{
				bullet1= new Bulletv3(this.X+13, this.Y-1, this.huong, 5, 4, 10, this.type, 1);
				bullet2= new Bulletv3(this.X+13, this.Y-1, this.huong, 5, 4, 10, this.type, 2);
				bullet3= new Bulletv3(this.X+13, this.Y-1, this.huong, 5, 4, 10, this.type, 1);
				bullet4= new Bulletv3(this.X+13, this.Y-1, this.huong, 5, 4, 10, this.type, 2);
				bullet5= new Bulletv3(this.X+13, this.Y-1, this.huong, 5, 4, 10, this.type, 0);
			}
			else
			if(this.huong == 1)
			{
				...
				bullet3 = new Bulletv3(this.X+30, this.Y+13, this.huong, 5, 10, 4, this.type,1);
				bullet4 = new Bulletv3(this.X+30, this.Y+13, this.huong, 5, 10, 4, this.type,2);
				bullet5 = new Bulletv3(this.X+30, this.Y+13, this.huong, 5, 10, 4, this.type,0);
			}
			else
			if(this.huong == 2)
			{
				bullet1 = new Bulletv3(this.X+13, this.Y+30, this.huong, 5, 4, 10, this.type,1);
				bullet2 = new Bulletv3(this.X+13, this.Y+30, this.huong, 5, 4, 10, this.type,2);
				bullet3 = new Bulletv3(this.X+13, this.Y+30, this.huong, 5, 4, 10, this.type,1);
				bullet4 = new Bulletv3(this.X+13, this.Y+30, this.huong, 5, 4, 10, this.type,2);
				bullet5 = new Bulletv3(this.X+13, this.Y+30, this.huong, 5, 4, 10, this.type,0);
			}
			else
			if(this.huong == 3)
			{
				...
				bullet3 = new Bulletv3(this.X-1, this.Y+13, this.huong, 5, 10, 4, this.type,1);
				bullet4 = new Bulletv3(this.X-1, this.Y+13, this.huong, 5, 10, 4, this.type,2);
				bullet5 = new Bulletv3(this.X-1, this.Y+13, this.huong, 5, 10, 4, this.type,0);
			}
			if (bullet1 != null || bullet2 != null || bullet3 != null || bullet4 != null || bullet5 != null)
			{
				...
				Tanks.O_Bullets.add(bullet4);
				Tanks.O_Bullets.add(bullet5);
			}	
