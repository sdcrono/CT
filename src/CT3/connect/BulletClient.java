...
public class BulletClient extends TanksClient{

	int host;//Dan tanks bot la 1, dan dong minh la 2.
	int lv=0;
	
	public BulletClient(int x, int y, int huong, int type, int wi, int le, int host) {
		...
		TanksClient.O_Bullets.add(this);
		super.Move();
...
//		
//		if(this.huong == 0)
//			for(BulletClient o:TanksClient.O_Bullets)
//			{
