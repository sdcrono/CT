...
public class TanksPlayerClient extends TanksClient  {
	...
	public TanksPlayerClient(int x, int y, int huong, int type,  int size) {
		...
		TanksPlayerClient.score = 0;
		
		weapon[1] = 10000;
		TanksClient.player ++;
		this.N_player = TanksClient.player; 
		O_Tanks.add(this);
