...
public class MTh2 extends Thread{
	...
	public MTh2(Socket sv, int numPlayer) {
		try {
			this.s=sv;
			this.N_player = numPlayer;
...
//				String s1 = bp.nextLine();			
				...
				for(Tanks o:Tanks.O_Tanks)
					if(o.type==3)
					{
						...
						{
							if(s1.equals("UP") || s1.equals("DOWN")|| s1.equals("LEFT") || s1.equals("RIGHT") || s1.equals("M") || s1.equals("N"))
								o.Pressed1(s1);
							if(s1.equals("UPS") || s1.equals("DOWNS")|| s1.equals("LEFTS") || s1.equals("RIGHTS") || s1.equals("MS") || s1.equals("NS"))
							{
								{
									if(s1.equals("UPS"))
										if(o.huong == 0)
...
//				}	
			...
			try{
				...
				Server.MThV.removeElement(this);
			}
